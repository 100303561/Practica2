				...
				<div class="row">
					<div class="col-md-8">
						...
						<div class="col-xs-12 offset-2">
							...
							<form data-form-type="contact" method="post" action="modifyUser"
								class="rd-mailform" onsubmit="return ConfirmModify()">
								...
								<!-- Para evitar que pueda modificar el email: disabled -->
								<input type="text" name="email"
									Value="<%=(u != null) ? u.getEmail() : "..."%>"> <input
									type="password" name="password"
									Value="<%=(u != null) ? u.getPassword() : "..."%>"> <select
						...
						<form method="post" action="deleteUser"
							...
							<!-- Guardar el id del usuario para borrar -->
							<input type="hidden" class="btn btn-primary btn-sm btn-shadow-1"
								name="idUser" value="<%=(u != null) ? u.getId() : "10"%>"> <input type="submit"
